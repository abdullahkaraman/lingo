    ...
    <div className="fixed inset-x-0 bottom-0 z-50 animate-slideUp">
      ...
      >
        ...
        <div className="flex items-center justify-between">
          ...
          {/* Correct word pill — always visible so players can note it */}
        ...
        <button
          onClick={onNewWord}
          className={[
            'w-full py-3 rounded-xl text-white font-black text-lg active:scale-95 transition-all duration-200',
            isSuccess
