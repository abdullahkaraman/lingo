...
export function WordLengthSetup({ onSelect }: WordLengthSetupProps) {
  return (
    <div className="flex flex-col items-center justify-center flex-1 gap-10 py-8 w-full">
      ...
      <div className="grid grid-cols-2 gap-4 w-full max-w-xs">
        {OPTIONS.map(({ length, difficulty }) => (
          <button
            ...
            className="flex flex-col items-center justify-center gap-2 py-7 px-4 rounded-2xl
          ...
          >
            <span className="text-6xl font-black text-yellow-400 leading-none">{length}</span>
